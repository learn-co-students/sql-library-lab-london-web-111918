...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series INNER JOIN characters ON characters.series_id = series.id GROUP BY characters.species HAVING MAX(characters.species = 'human') LIMIT 1;"
end
